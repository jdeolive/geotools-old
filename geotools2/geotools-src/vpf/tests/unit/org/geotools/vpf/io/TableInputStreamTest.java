...
public class TableInputStreamTest extends TestCase
{
  ...
  protected void setUp() {
    ...
    // for example:
    // varTableInputStream = new TableInputStream(...);
    // But note that there is no default constructor in TableInputStream
  } // end of setUp()
  /**
  ...
  /**
   * Method for testing original source method:
   * org.geotools.vpf.TableColumnDef readColumnDef()
   * from tested class
   */
  public void testReadColumnDef() {

    assertTrue("Warning! This is new test method with no real test code inside.", false);

  } // end of testReadColumnDef()
  ...
  /**
   * Method for testing original source method:
   * java.lang.String readString(java.lang.String)
   * from tested class
   */
  public void testReadString1195259493() {

    assertTrue("Warning! This is new test method with no real test code inside.", false);

  } // end of testReadString1195259493(java.lang.String)
