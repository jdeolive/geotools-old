...
public class GMLFilterGeometry extends org.xml.sax.helpers.XMLFilterImpl
     ...
     * geometry notice.
     *
     * @param localName The local name of the geometry, which corresponds to
     * an OGC simple feature type.
     ...
     * status of the current handler and either returns the finished JTS object
     * to its parent or passes the element end notification along to the
     * current handler as a sub geometry notice.
     *
    ...
    /**
     * Gets a coordinate from the child and passes it to the current handler
     * as an add request.
     *
     ...
     * which interprets them appropriately, depending on its current state.
     *
