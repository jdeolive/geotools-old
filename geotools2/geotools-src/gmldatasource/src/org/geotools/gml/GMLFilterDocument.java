...
public class GMLFilterDocument extends org.xml.sax.helpers.XMLFilterImpl {
    ...
    new java.util.Vector(java.util.Arrays.asList(
    new String[] {"Point", "LineString", "Polygon", "LinearRing", "Box",
     ...
     * sends it directly on down the chain to the appropriate
     * parent handler.  If it is a coordinates (or coord) element,
    ...
    private class CoordinateReader {
        ...
        /**
         * Reads raw coordinates from the GML and returns them to the parent
         * as neat functions.
         *
         ...
         *
         * @param isInside Sets whether or not we are 
         * inside a <coordinates> tag.
         ...
         * Sets an entrance into a <coordinates> element.
         *
         * @param isInside Sets whether or not we are inside
         * a <coordinates> tag.
         */
        public void insideCoordinates(boolean isInside) {
        ...
        throws SAXException {
            ...
            if (isInside) {
                ...
                // set all coordinates to null and note 
                // that we have left the <coord> tag
