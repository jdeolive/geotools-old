...
final class LineString implements Serializable {
     ...
     * @see #getResolution
     */
    public static void setResolution(LineString scan, final CoordinateTransformation transformation,
                                     double resolution)
            throws TransformException
    {
        /*
    ...
    public static LineString freeze(LineString scan, final boolean close,
        ...
        while (scan!=null) {
            ...
            for (int arrayID=FIRST_ARRAY; arrayID<=LAST_ARRAY; arrayID++) {
                final PointArray array = scan.getArray(arrayID);
                if (array != null) {
                    scan.setArray(arrayID, array.getFinal(arrayID==0 ? compress : null));
                }
            }
            /*
