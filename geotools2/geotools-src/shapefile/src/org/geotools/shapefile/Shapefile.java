...
public class Shapefile {
    ...
    private cmp.LEDataStream.LEDataOutputStream getOutputStream()
        throws IOException {
        ...
        java.io.BufferedOutputStream in = new java.io.BufferedOutputStream(
                                                  connection.getOutputStream());
        cmp.LEDataStream.LEDataOutputStream sfile = new cmp.LEDataStream.LEDataOutputStream(
                                                            in);
    ...
    private LEDataInputStream setup() throws IOException {
        ...
        if (inStream == null) {
            throw new IOException("Failed connection or no content for " + 
                                  baseURL);
        }
    ...
    public com.vividsolutions.jts.geom.GeometryCollection read(com.vividsolutions.jts.geom.GeometryFactory geometryFactory)
        ...
        if (handler == null) {
            throw new ShapeTypeNotSupportedException("Unsuported shape type:" + 
                                                     type);
        }
        ...
        try {
            ...
            LOGGER.warning(
                    "Truncating feature loading. Some features may not have been read");
        ...
        return geometryFactory.createGeometryCollection(
                       (Geometry[]) list.toArray(new Geometry[] {  }));
    }
    ...
    public void write(com.vividsolutions.jts.geom.GeometryCollection geometries)
        ...
        Geometry body;
        ShapeHandler handler = Shapefile.getShapeHandler(
                                       geometries.getGeometryN(0));
    ...
    public synchronized void readIndex(java.io.InputStream is)
                                throws IOException {
