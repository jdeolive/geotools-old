...
/**
 * Represents the Filter capabilities that are supported by
 * a SQLEncoder.  Each SQLEncoder class should have one
 * static FilterCapabilities, representing the filter encoding
 * operations that it can successfully perform.
 *
...
public class FilterCapabilities {
    ...
    /**
     * Determines if the filter and all its sub filters are supported.  Is
     * most important for logic filters, as they are the only ones with 
     * subFilters.
     *
     *@param filter the filter to be tested.
