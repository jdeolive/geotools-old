...
{
	/** Used by the servlet to send init parameters to the WMSServer implementation
	 * @param properties A Properties object containing all the information a given 
	 * implementation may need to initialize. Typically, the properties are all the 
	 * same as those sent to the servlet through it's <init-param> tags.
	 */
