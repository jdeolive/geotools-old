...
/**
 * An Exception object in the same form as a WMS 1.1.1 exception message, which
 * uese a code value and a detailed message to send erors back to the client.
 * This Exception type, when thrown by a implementor of WMSServer, will cause
...
public class WMSException extends Exception {
    ...
    /**
     * InvalidSRS Request contains an SRS not offered by the service instance
    ...
    /**
     * StyleNotDefined Request is for a Layer in a Style not offered by the
     * service instance.
     */
    public static final String WMSCODE_STYLENOTDEFINED = "StyleNotDefined";

    /**
     * LayerNotQueryable GetFeatureInfo request is applied to a Layer which is
     * not declared queryable.
     */
     ...
     * GetCapabilities request is greater than current value of Capabilities
