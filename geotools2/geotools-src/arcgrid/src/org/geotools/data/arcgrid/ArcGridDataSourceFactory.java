...
/**
 * Implementation of the DataSource service provider interface for arc grid files.
 *
 * @author aaime
 */
public class ArcGridDataSourceFactory implements org.geotools.data.DataSourceFactorySpi {
    /**
    ...
    public boolean canProcess(Map params) {
        ...
        if (params.containsKey("url")) {
            ...
            accept = url.toUpperCase().endsWith("ASC");
        }
     ...
     * an arc grid file.
     *
     * @param params A param list with information on the location of a resource.  For arc grid
     *        files this should contain a 'url' param which points to a file which ends in asc.
     *
    ...
    public DataSource createDataSource(Map params) throws DataSourceException {
        ...
        if (canProcess(params)) {
            ...
            try {
                ds = new ArcGridDataSource(new URL(location));
