 ...
 * <ul>
 * <li>name: user's name of validation test</li>
 * <li>description: user's description of validation test</li>
 * <li>priority: used to schedule validation test</li>
 * <li>typeNames: used to connect validaiton test to transaction opperation</li>
 * </ul>
 * </p>
 *
 * @author bowens, Refractions Research, Inc.
 * @author $Author: jive $ (last modification)
 * @version $Id: Validation.java,v 1.1 2004/02/13 03:07:59 jive Exp $
 */
public interface Validation {
    /**
     * A constant for getPriority() used for Trivial validation checks.
     * <p>
     * This is a Priority Hint to Validation Processor based
     ...
     * </p>
     * <p>
     * Used for simple attribute or geometry validations, basically
     * anything that is Order(N) like a Bounds check.  
     * </p>
     */
     ...
     * </p>
     * <p>
     * Used for complex validations, basically anything that
     * is has a Chance of being worse then O(N).
     * </p>
     * <p>
     * Any integrity tests between two FeatureTypes should
     * be an example of a PRIORITY_COMPLEX.
     * </p>
     */
     ...
     * </p>
     * <p>
     * Used for involved validations, basically anything that
     * is has a Chance of being worse then O(N^2).
     * </p>
     * <p>
     ...
     * (If this does not Pan out we may have to define the
     * wild-card character "*" or support Regex based typeName matching.
     * </p>
     */
     ...
     * <p>
     * If this list is empty the ValidationProcess will run the test
     * against all FeatureTypes. The ValidationProcess expects these names
     * to be in the format dataStoreId:typeName.
     * </p>
     *
     * @return FeatureType names that this validation test is run
     *         against, empty for all, null to disable
     */
    String[] getTypeRefs();
}
