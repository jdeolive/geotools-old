/* $Id: SQLEncoderOracleTest.java,v 1.1 2003/08/02 02:34:29 seangeo Exp $
 * 
 ...
 * @version $Id: SQLEncoderOracleTest.java,v 1.1 2003/08/02 02:34:29 seangeo Exp $
 * Last Modified: $Date: 2003/08/02 02:34:29 $ 
 */
public class SQLEncoderOracleTest extends TestCase {
    ...
    public void testGeometryFilterEncoder() throws Exception {
        ...
        assertEquals("WHERE SDO_RELATE(\"GEOM\",MDSYS.SDO_GEOMETRY(1002,NULL," +
            "NULL,MDSYS.SDO_ELEM_INFO_ARRAY(1,2,1),MDSYS.SDO_ORDINATE_ARRAY(" +            "-10.0,-10.0,10.0,10.0)),'mask=overlapbydisjoint querytype=WINDOW') = 'TRUE' ",
            value);
    }
}
