    ...
    private java.awt.Font getFont(Feature feature, 
        ...
        for (int k = 0; k < fonts.length; k++) {
            ...
            if (fontFamilies.contains(requestedFont)) {
                ...
                size = ((Number) fonts[k].getFontSize().getValue(feature)).intValue();
                LOGGER.info("requesting " + requestedFont + " " + styleCode + 
                            " " + size);
    ...
    private void drawWithGraphicStroke(Graphics2D graphic, GeneralPath path, 
        ...
        while (!pi.isDone()) {
            ...
            case PathIterator.SEG_CLOSE:
                ...
                coords[0] = first[0];
                coords[1] = first[1];
                LOGGER.finer("closing from " + previous[0] + "," + 
            ...
            case PathIterator.SEG_LINETO:
                ...
                LOGGER.finer("drawing from " + previous[0] + "," + 
                             previous[1] + " to " + coords[0] + "," + 
                             coords[1]);
                ...
                LOGGER.finer("loop end dist " + dist + " len " + len + " " + 
                             (len - dist));
