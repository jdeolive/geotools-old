 ...
 */
/*
 * RasterSymbolizer.java
 *
 * Created on 07 November 2002, 15:42
 */
 ...
 * (e.g., satellite photos, DEMs).  It is defined as follows:
 * <PRE>
...
public interface RasterSymbolizer extends Symbolizer {
     ...
     * change). If none of Normalize, Histogram, or GammaValue are selected
