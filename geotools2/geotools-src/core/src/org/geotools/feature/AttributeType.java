...
/**
 * <p>
 * Stores metadata about a single attribute object.  Note that schemas are also
 * attributes.  All attribute implementations must be immutable.  All
 * attributes must have four properties:
 * 
 * <ol>
 * <li>
 ...
 * </li>
 * <li>
 * Occurences: Number of instances of this attribute per <code>Feature</code>.
 * </li>
 * <li>
 * Type: The expected Java class of this attribute.
 * </li>
 * <li>
 * Position: All schemas are ordered, so they store the associated position of
 * the attribute.
 * </li>
 * </ol>
 * </p>
 ...
 * @version $Id: AttributeType.java,v 1.8 2003/05/07 16:53:04 jmacgill Exp $
 */
