 ...
 * FeatureTypes are meant to be immutable, this object is mutable.
 * 
 * <p>
 ...
 * </pre></code> There are also a set of convenience
 * methods for creation of FeatureTypes. These are the various newFeatureType
 * methods.
 * </p>
 * 
 * <p>
 * <b>Remember, changes to any state will invalidate the current FeatureType,
 * if one exists</b><br>
