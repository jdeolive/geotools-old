...
/**
 * Liste de noms de préfix qui dépendront de la langue de l'utilisateur.
 * L'usager ne devrait pas créer lui-même des instances de cette classe.
 * Une instance statique sera créée une fois pour toute lors du chargement
...
public class Prefix extends SymbolResources {
    ...
    private final static Prefix resources =
        (Prefix) getBundle("org.geotools.resources.units.Prefix");
