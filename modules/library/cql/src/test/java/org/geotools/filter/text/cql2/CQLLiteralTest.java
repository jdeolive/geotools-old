...
public class CQLLiteralTest {
    ...
    public void geometryLiterals() throws Exception {
        ...
        // Point
        result = (BinarySpatialOperator) CompilerUtil.parseFilter(this.language, "CROSS(ATTR1, POINT(1 2))");
        ...
        // LineString
        result = (BinarySpatialOperator) CompilerUtil.parseFilter(this.language,"CROSS(ATTR1, LINESTRING(1 2, 10 15))");
