...
public abstract class AbstractResourceList extends AbstractResourceCollection
     ...
     * returns the lowest index <tt>i</tt> such that <tt>(o==null ?
     * get(i)==null : o.equals(get(i)))</tt>,
     ...
     * index)</tt>
     * or <tt>removeRange(int fromIndex, int toIndex)</tt> is overridden.
     * 
     * @throws UnsupportedOperationException
     ...
     * @throws IllegalArgumentException
     *             some aspect an element of the specified collection prevents
     *             it from being added to this List.
     * @throws IndexOutOfBoundsException
     *             index out of range (<tt>index &lt; 0
     *            || index &gt; size()</tt>).
     ...
     * so, it returns <tt>true</tt>; if not, it checks if the specified
     ...
     * any comparison returns <tt>false</tt>, this method returns
     ...
     * hash function in the documentation for the <tt>List.hashCode</tt>
     * method.
     * 
