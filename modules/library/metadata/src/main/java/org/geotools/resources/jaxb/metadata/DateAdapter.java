...
/**
 * JAXB adapter in order to surround the date value with a {@code <gco:Date>} tags,
 ...
 */
public class DateAdapter extends XmlAdapter<DateAdapter, Date> {
    /**
     * The date value.
     */
    private Date date;
     ...
     */
    protected DateAdapter(final Date date) {
        this.date = date;
    }
