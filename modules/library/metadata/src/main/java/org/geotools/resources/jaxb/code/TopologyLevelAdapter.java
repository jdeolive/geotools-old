...
/**
 * JAXB adapter for {@link TopologyLevel}, in order to integrate the value in a tags
        ...
        extends CodeListAdapter<TopologyLevelAdapter, TopologyLevel>
{
     ...
     */
    private TopologyLevelAdapter() {
    }

    public TopologyLevelAdapter(final CodeListProxy proxy) {
        super(proxy);
    }
