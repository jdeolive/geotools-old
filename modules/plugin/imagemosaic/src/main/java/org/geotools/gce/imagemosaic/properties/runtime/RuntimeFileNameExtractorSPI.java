 ...
 */
package org.geotools.gce.imagemosaic.properties.runtime;
...
/**
 * SPI for the extraction of run information from {@link File} names.
 * 
 * @author Simone Giannecchini, GeoSolutions SAS
 *
 */
public class RuntimeFileNameExtractorSPI extends
		DefaultPropertiesCollectorSPI implements PropertiesCollectorSPI {

	public RuntimeFileNameExtractorSPI() {
		super("RuntimeFileNameExtractorSPI");
	}
	...
	public PropertiesCollector create(
		...
		if(properties.containsKey("regex"))
			return new RuntimeFileNameExtractor(this,propertyNames,properties.getProperty("regex"));
