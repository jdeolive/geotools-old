...
class RuntimeFileNameExtractor extends RegExPropertiesCollector {
	private final static Logger LOGGER= Logging.getLogger(RuntimeFileNameExtractor.class);


	public RuntimeFileNameExtractor(
	...
	public void setProperties(SimpleFeature feature) {
		...
		for(String match:getMatches()){
			...
			try {
				values.add(Integer.valueOf(match));
