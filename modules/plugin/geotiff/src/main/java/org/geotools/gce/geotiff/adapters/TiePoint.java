 ...
 * @since 2.3
 *
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/plugin/geotiff/src/main/java/org/geotools/gce/geotiff/adapters/TiePoint.java $
 * @deprecated use {@link org.geotools.coverage.grid.io.imageio.geotiff.TiePoint}
 */
