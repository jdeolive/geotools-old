 ...
 * @author Mike Nidel
 *
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/plugin/geotiff/src/main/java/org/geotools/gce/geotiff/adapters/GeoKeyEntry.java $
 * @deprecated use {@link org.geotools.coverage.grid.io.imageio.geotiff.GeoKeyEntry}
 */
