...
public class DatabaseCreationScript {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        String inputDirectory = "/home/aaime/devel/gttrunk/modules/plugin/epsg-hsql/src/main/resources/org/geotools/referencing/factory/epsg/";
...
//            final File backup = new File(directory, ThreadedHsqlEpsgFactory.DATABASE_NAME + ".backup");
//            if (backup.exists()) {
//                backup.delete();
//            }
