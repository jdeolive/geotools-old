...
public class DB2PrimaryKeyFinderTestSetup extends JDBCPrimaryKeyFinderTestSetup {
    ...
    protected void createMetadataTable() throws Exception {
        ...
        con.prepareStatement("CREATE TABLE \""+DB2TestUtil.SCHEMA.toUpperCase()+ "\".gt_pk_metadata_table ( " + "table_schema VARCHAR(32) not null, "
    ...
    protected void dropMetadataTable() throws Exception {
        ...
        try {                
                ...
                DB2TestUtil.dropTable(DB2TestUtil.SCHEMA.toUpperCase(), "gt_pk_metadata_table".toUpperCase(), con);
    ...
    protected void createSequencedPrimaryKeyTable() throws Exception {
        ...
        con.prepareStatement("INSERT INTO \""+DB2TestUtil.SCHEMA.toUpperCase()+ "\".gt_pk_metadata_table VALUES"
