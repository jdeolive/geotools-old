...
public class TypeSystemTest extends TestCase {
    ...
    public void testSchema() {
        ...
        TypeName name = typeName(URI, "Text");
    ...
    static final TypeName typeName(String uri, String type) {
        return new org.geotools.feature.type.TypeName(uri, type);
    }

    static final TypeName typeName(String name) {
        return typeName(null, name);
    }
