...
public class DataSystemTest extends TestCase {
	...
	public void testSimpleComplexAttribute() {
		...
		Collection contents = (Collection) fullname.get();
	...
	public void testCompountComplexAttribute() {
		...
		Collection contents = (Collection) address.get();
	...
	public void testGeometryAttribute() {
		...
		assertEquals(0, ((Point) location.get()).getX(), 0);
	}
	...
	public void testFeature() {
		...
		Collection contents = (Collection) person.get();
	...
	public void testFeatureCollection() {
		...
		FeatureCollection canada = factory.createFeatureCollection(
