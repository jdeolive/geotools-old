...
public class TypeBuilder {
	 ...
	 */
	protected TypeName createTypeName(String ns, String local) {
	 ...
	 * 
	 * @return {@link org.geotools.feature.iso.Types#attributeName(String, String)}
	 */
	protected Name createName(String ns, String local) {
		return Types.attributeName(ns, local);
	}
