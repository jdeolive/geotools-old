...
public class SimpleTypeBuilder {
    ...
    public void addAttribute(String name, Class bind) {
        ...
        AttributeType type;
        TypeName typeName = Types.typeName(name);
        if (prototype != null) {
    ...
    protected AttributeType createPrototype(TypeName typeName,
            AttributeType proto) {
        return factory.createAttributeType(typeName, proto.getBinding(), false,
                false, Collections.EMPTY_SET, null, null);
    }

    protected GeometryType createPrototype(TypeName typeName,
            AttributeType proto, CoordinateReferenceSystem crs) {
        return factory.createGeometryType(typeName, proto.getBinding(), crs,
    ...
    protected AttributeType createType(TypeName typeName, Class bind) {
        return factory.createAttributeType(typeName, bind, false, false,
                Collections.EMPTY_SET, null, null);
    }

    protected GeometryType createType(TypeName typeName, Class bind,
            CoordinateReferenceSystem crs) {
        return factory.createGeometryType(typeName, bind, crs, false, false,
                Collections.EMPTY_SET, null, null);
    }
}
