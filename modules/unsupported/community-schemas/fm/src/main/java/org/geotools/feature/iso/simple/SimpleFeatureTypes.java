...
public class SimpleFeatureTypes {
    ...
    public SimpleFeatureType sub(SimpleFeatureType featureType, Name[] properties) {
        ...
        boolean same = featureType.getNumberOfAttribtues() == properties.length;
        
        for (int i = 0; (i < featureType.getNumberOfAttribtues()) && same; i++) {
            AttributeType type = featureType.get(i);
