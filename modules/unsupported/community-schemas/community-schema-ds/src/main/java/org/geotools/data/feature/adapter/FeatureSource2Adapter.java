 ...
 * @version $Id$
 * @source $URL:
 *         http://svn.geotools.org/geotools/branches/2.4.x/modules/unsupported/community-schemas/community-schema-ds/src/main/java/org/geotools/data/feature/adapter/FeatureSource2Adapter.java $
 * @since 2.4
 */
public class FeatureSource2Adapter implements FeatureSource2 {
    ...
    public FeatureSource2Adapter(FeatureAccessAdapter dataStore, FeatureSource featureSource,
        ...
        descriptor = tf.createAttributeDescriptor(isoFeatureType, isoFeatureType.getName(), 0,
    ...
    public Collection content(Filter filter, int countLimit) {
        ...
        Collection isoFeatures = new FeatureCollectionAdapter(isoFeatureType, features,
                attributeFactory);
        return isoFeatures;
    }
    ...
    public Name getName() {
        ...
        Name typeName = Types.typeName(nsUri, name);
        return typeName;
    }
