 ...
 * <p>
 * This configuration object contains all the needed elements for a ComplexDataStore
 * to aquire the source and target FeatureTypes, and apply the mappings between
 * attributes to serve community schemas. 
 * </p>
 *
...
public class ComplexDataStoreDTO implements Serializable {
    ...
    /**
     * List of configuration objects used to aquire the datastores that
     * provides the source FeatureTypes. Source feature types are those
     * internally defined whose Feature instances are converted to features of
     * the target schemas by applying the FeatureTypeMappings.
     */
     ...
     * DOCUMENT ME!
     *
     * @param baseSchemasUrl DOCUMENT ME!
     */
