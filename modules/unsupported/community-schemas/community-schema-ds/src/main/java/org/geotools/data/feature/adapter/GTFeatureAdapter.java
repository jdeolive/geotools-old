...
public class GTFeatureAdapter implements org.geotools.feature.SimpleFeature {
    ...
    public Object getAttribute(String xPath) {
        Object value = adaptee.getValue(xPath);
        return value;
    }

    public Object getAttribute(int index) {
        Object value = adaptee.getValue(index);
        return value;
    }
...
//        envelope.init(adaptee.getBounds());
    ...
    public void setAttribute(int position, Object val)
        ...
        adaptee.setValue(position, val);
    }

    public void setAttribute(String xPath, Object attribute)
            throws IllegalAttributeException {
        adaptee.setValue(xPath, attribute);
    }
    ...
    public void setDefaultGeometry(Geometry geometry)
        ...
        GeometryType defGeomType = (GeometryType) descriptor.type();
    ...
    public void setAttributes(Object[] attributes)
        ...
        for (Iterator it = atts.iterator(); it.hasNext();) {
            Attribute att = (Attribute) it.next();
            att.setValue(attributes[current]);
            current++;
        }
