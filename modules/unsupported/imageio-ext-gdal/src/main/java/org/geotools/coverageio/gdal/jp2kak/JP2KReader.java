 ...
 * @since 2.5.x
 */
public final class JP2KReader extends DefaultGDALGridCoverage2DReader implements GridCoverageReader {
    /** Logger. */
    ...
    public JP2KReader(Object input, final Hints hints)
        throws DataSourceException {
        super(input, hints, false, worldFileExt, new JP2GDALKakaduImageReaderSpi());
    }
