 ...
 * @since 2.5.x
 */
public final class JP2MrSIDReader extends DefaultGDALGridCoverage2DReader implements GridCoverageReader {
    /** Logger. */
    ...
    public JP2MrSIDReader(Object input, final Hints hints)
        throws DataSourceException {
        super(input, hints, false, worldFileExt, new JP2GDALMrSidImageReaderSpi());
    }
