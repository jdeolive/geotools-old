...
class JDBCAccessPostGis extends JDBCAccessBase {
    private String SRSSelect = "select srid from geometry_columns where f_table_schema=? and f_table_name=? and f_geometry_column=? ";
    private String CRSSelect = "select srtext from spatial_ref_sys where srid=?";
