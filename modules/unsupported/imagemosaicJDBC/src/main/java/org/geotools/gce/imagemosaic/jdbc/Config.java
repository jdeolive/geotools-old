...
class Config {
    static private Map<String, Config> ConfigMap = new Hashtable<String, Config>(); // Hashtable is synchronized
    ...
    static Config readFrom(URL xmlURL) throws Exception {
        ...
        // db mapping
        result.spatialExtension = readNameString(dom.getDocumentElement(),
                "spatialExtension");
    ...
    //		StringBuffer buff = new StringBuffer ("select ").append(blobAttributeNameInTileTable ).append(" from ")
