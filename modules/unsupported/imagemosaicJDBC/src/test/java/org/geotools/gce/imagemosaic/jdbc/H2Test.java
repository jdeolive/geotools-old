...
public class H2Test extends AbstractTest {
    ...
    public void testReproject1() {    	
        ...
        try {
            ...
            imageMosaic("partialgreen_reprojected", getJDBCSetup().getConfigUrl(), tenv, 400, 400,Color.GREEN,source);
        } catch (Exception e) {
    ...
    public void testOutputTransparentColor() {
        ...
        try {
            ...
            imageMosaic("partialgreen", getJDBCSetup().getConfigUrl(), env, 400, 400,Color.GREEN,null);
        } catch (Exception e) {
            Assert.fail(e.getMessage());
        }
    }
