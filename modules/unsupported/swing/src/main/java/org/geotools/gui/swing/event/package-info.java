 ...
 * <li>map coordinates: the position in world coordinates as defined by the MapContext CoordianteReferenceSystem
 * (for "EPSG:4326" these would be on lon/lat)</li>
 * <li>data coordaintes: the position in data coordiantes as defined by a single MapLayer</li>
 * </ul>
 */
