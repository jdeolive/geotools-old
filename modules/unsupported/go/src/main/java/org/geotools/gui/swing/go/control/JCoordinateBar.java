...
public class JCoordinateBar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(jtf_coord, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE))
        );
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        if(map != null && map.getCanvas().getObjectiveCRS() != null){
            defaultCRS = map.getCanvas().getObjectiveCRS();          
        }
    ...
    private class myListener extends MouseMotionAdapter{
        ...
        private void update(MouseEvent event){
            ...
            jtf_coord.setText("X= "+ coord.getX() +"  /  Y= "+coord.getY());
//            
//            AffineTransform2D trs = new AffineTransform2D(map.getCanvas().getController().getTransform());
//            
