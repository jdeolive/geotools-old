 ...
 * </p>
 *
 * @see net.opengis.gml.Gml4wcsPackage#getCodeType()
...
public interface CodeType extends EObject {
     ...
     * @see #setValue(String)
     * @see net.opengis.gml.Gml4wcsPackage#getCodeType_Value()
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getCodeType_CodeSpace()
