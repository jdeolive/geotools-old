 ...
 * </p>
 *
 * @see net.opengis.gml.Gml4wcsPackage#getTimePositionType()
...
public interface TimePositionType extends EObject {
     ...
     * @see #setValue(Object)
     * @see net.opengis.gml.Gml4wcsPackage#getTimePositionType_Value()
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getTimePositionType_CalendarEraName()
     ...
     * @see #unsetFrame()
     * @see #setFrame(String)
     * @see net.opengis.gml.Gml4wcsPackage#getTimePositionType_Frame()
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getTimePositionType_IndeterminatePosition()
