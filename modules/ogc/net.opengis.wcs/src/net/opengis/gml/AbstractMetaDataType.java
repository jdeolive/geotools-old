 ...
 * </p>
 *
 * @see net.opengis.gml.Gml4wcsPackage#getAbstractMetaDataType()
 * @model abstract="true"
...
public interface AbstractMetaDataType extends EObject {
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getAbstractMetaDataType_Mixed()
     ...
     * @see #setId(String)
     * @see net.opengis.gml.Gml4wcsPackage#getAbstractMetaDataType_Id()
