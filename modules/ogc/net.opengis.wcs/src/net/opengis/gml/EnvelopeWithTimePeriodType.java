 ...
 * </p>
 *
 * @see net.opengis.gml.Gml4wcsPackage#getEnvelopeWithTimePeriodType()
...
public interface EnvelopeWithTimePeriodType extends EnvelopeType {
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getEnvelopeWithTimePeriodType_TimePosition()
     ...
     * @see #unsetFrame()
     * @see #setFrame(String)
     * @see net.opengis.gml.Gml4wcsPackage#getEnvelopeWithTimePeriodType_Frame()
