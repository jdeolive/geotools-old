 ...
 * </p>
 *
 * @see net.opengis.gml.Gml4wcsPackage#getBoundingShapeType()
...
public interface BoundingShapeType extends EObject {
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getBoundingShapeType_EnvelopeGroup()
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getBoundingShapeType_Envelope()
