 ...
 * </p>
 *
 * @see net.opengis.gml.Gml4wcsPackage#getMetaDataPropertyType()
...
public interface MetaDataPropertyType extends EObject {
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getMetaDataPropertyType_MetaDataGroup()
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getMetaDataPropertyType_MetaData()
     ...
     * @see #setAbout(String)
     * @see net.opengis.gml.Gml4wcsPackage#getMetaDataPropertyType_About()
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getMetaDataPropertyType_Actuate()
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getMetaDataPropertyType_Arcrole()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
     ...
     * @see #setHref(String)
     * @see net.opengis.gml.Gml4wcsPackage#getMetaDataPropertyType_Href()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getMetaDataPropertyType_RemoteSchema()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
     ...
     * @see #setRole(String)
     * @see net.opengis.gml.Gml4wcsPackage#getMetaDataPropertyType_Role()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getMetaDataPropertyType_Show()
     ...
     * @see #setTitle(String)
     * @see net.opengis.gml.Gml4wcsPackage#getMetaDataPropertyType_Title()
     ...
     * @see #unsetType()
     * @see #setType(String)
     * @see net.opengis.gml.Gml4wcsPackage#getMetaDataPropertyType_Type()
