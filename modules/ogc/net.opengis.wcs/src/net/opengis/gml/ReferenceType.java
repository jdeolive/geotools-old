 ...
 * </p>
 *
 * @see net.opengis.gml.Gml4wcsPackage#getReferenceType()
...
public interface ReferenceType extends EObject {
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getReferenceType_Actuate()
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getReferenceType_Arcrole()
     ...
     * @see #setHref(String)
     * @see net.opengis.gml.Gml4wcsPackage#getReferenceType_Href()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getReferenceType_RemoteSchema()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
     ...
     * @see #setRole(String)
     * @see net.opengis.gml.Gml4wcsPackage#getReferenceType_Role()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getReferenceType_Show()
     ...
     * @see #setTitle(String)
     * @see net.opengis.gml.Gml4wcsPackage#getReferenceType_Title()
     ...
     * @see #unsetType()
     * @see #setType(String)
     * @see net.opengis.gml.Gml4wcsPackage#getReferenceType_Type()
