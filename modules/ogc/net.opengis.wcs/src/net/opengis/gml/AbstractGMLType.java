 ...
 * </p>
 *
 * @see net.opengis.gml.Gml4wcsPackage#getAbstractGMLType()
 * @model abstract="true"
...
public interface AbstractGMLType extends EObject {
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getAbstractGMLType_MetaDataProperty()
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getAbstractGMLType_Description()
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getAbstractGMLType_Name()
