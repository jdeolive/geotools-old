 ...
 * </p>
 *
 * @see net.opengis.gml.Gml4wcsPackage#getCodeListType()
...
public interface CodeListType extends EObject {
     ...
     * @see #setValue(List)
     * @see net.opengis.gml.Gml4wcsPackage#getCodeListType_Value()
     ...
     * @see net.opengis.gml.Gml4wcsPackage#getCodeListType_CodeSpace()
