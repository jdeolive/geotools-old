...
public class GridLimitsTypeImpl extends EObjectImpl implements GridLimitsType {
    ...
    protected EClass eStaticClass() {
        return Gml4wcsPackage.Literals.GRID_LIMITS_TYPE;
    }
    ...
    public NotificationChain basicSetGridEnvelope(GridEnvelopeType newGridEnvelope, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.GRID_LIMITS_TYPE__GRID_ENVELOPE, oldGridEnvelope, newGridEnvelope);
    ...
    public void setGridEnvelope(GridEnvelopeType newGridEnvelope) {
        if (newGridEnvelope != gridEnvelope) {
            ...
            if (gridEnvelope != null)
                msgs = ((InternalEObject)gridEnvelope).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Gml4wcsPackage.GRID_LIMITS_TYPE__GRID_ENVELOPE, null, msgs);
            if (newGridEnvelope != null)
                msgs = ((InternalEObject)newGridEnvelope).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Gml4wcsPackage.GRID_LIMITS_TYPE__GRID_ENVELOPE, null, msgs);
            msgs = basicSetGridEnvelope(newGridEnvelope, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.GRID_LIMITS_TYPE__GRID_ENVELOPE, newGridEnvelope, newGridEnvelope));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Gml4wcsPackage.GRID_LIMITS_TYPE__GRID_ENVELOPE:
