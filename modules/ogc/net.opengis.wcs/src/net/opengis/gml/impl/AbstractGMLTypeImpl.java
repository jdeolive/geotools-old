...
public abstract class AbstractGMLTypeImpl extends EObjectImpl implements AbstractGMLType {
    ...
    protected EClass eStaticClass() {
        return Gml4wcsPackage.Literals.ABSTRACT_GML_TYPE;
    }
    ...
    public EList getMetaDataProperty() {
        if (metaDataProperty == null) {
            metaDataProperty = new EObjectContainmentEList(MetaDataPropertyType.class, this, Gml4wcsPackage.ABSTRACT_GML_TYPE__META_DATA_PROPERTY);
        }
    ...
    public NotificationChain basicSetDescription(StringOrRefType newDescription, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.ABSTRACT_GML_TYPE__DESCRIPTION, oldDescription, newDescription);
    ...
    public void setDescription(StringOrRefType newDescription) {
        if (newDescription != description) {
            ...
            if (description != null)
                msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Gml4wcsPackage.ABSTRACT_GML_TYPE__DESCRIPTION, null, msgs);
            if (newDescription != null)
                msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Gml4wcsPackage.ABSTRACT_GML_TYPE__DESCRIPTION, null, msgs);
            msgs = basicSetDescription(newDescription, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.ABSTRACT_GML_TYPE__DESCRIPTION, newDescription, newDescription));
    }
    ...
    public EList getName() {
        if (name == null) {
            name = new EObjectContainmentEList(CodeType.class, this, Gml4wcsPackage.ABSTRACT_GML_TYPE__NAME);
        }
        return name;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Gml4wcsPackage.ABSTRACT_GML_TYPE__META_DATA_PROPERTY:
                return ((InternalEList)getMetaDataProperty()).basicRemove(otherEnd, msgs);
            case Gml4wcsPackage.ABSTRACT_GML_TYPE__DESCRIPTION:
                return basicSetDescription(null, msgs);
            case Gml4wcsPackage.ABSTRACT_GML_TYPE__NAME:
