...
public class AbstractRingPropertyTypeImpl extends EObjectImpl implements AbstractRingPropertyType {
    ...
    protected EClass eStaticClass() {
        return Gml4wcsPackage.Literals.ABSTRACT_RING_PROPERTY_TYPE;
    }
    ...
    public NotificationChain basicSetLinearRing(LinearRingType newLinearRing, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.ABSTRACT_RING_PROPERTY_TYPE__LINEAR_RING, oldLinearRing, newLinearRing);
    ...
    public void setLinearRing(LinearRingType newLinearRing) {
        if (newLinearRing != linearRing) {
            ...
            if (linearRing != null)
                msgs = ((InternalEObject)linearRing).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Gml4wcsPackage.ABSTRACT_RING_PROPERTY_TYPE__LINEAR_RING, null, msgs);
            if (newLinearRing != null)
                msgs = ((InternalEObject)newLinearRing).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Gml4wcsPackage.ABSTRACT_RING_PROPERTY_TYPE__LINEAR_RING, null, msgs);
            msgs = basicSetLinearRing(newLinearRing, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.ABSTRACT_RING_PROPERTY_TYPE__LINEAR_RING, newLinearRing, newLinearRing));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Gml4wcsPackage.ABSTRACT_RING_PROPERTY_TYPE__LINEAR_RING:
