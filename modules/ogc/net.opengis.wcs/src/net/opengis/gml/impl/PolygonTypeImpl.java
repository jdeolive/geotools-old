...
public class PolygonTypeImpl extends AbstractSurfaceTypeImpl implements PolygonType {
    ...
    protected EClass eStaticClass() {
        return Gml4wcsPackage.Literals.POLYGON_TYPE;
    }
    ...
    public NotificationChain basicSetExterior(AbstractRingPropertyType newExterior, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.POLYGON_TYPE__EXTERIOR, oldExterior, newExterior);
    ...
    public void setExterior(AbstractRingPropertyType newExterior) {
        if (newExterior != exterior) {
            ...
            if (exterior != null)
                msgs = ((InternalEObject)exterior).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Gml4wcsPackage.POLYGON_TYPE__EXTERIOR, null, msgs);
            if (newExterior != null)
                msgs = ((InternalEObject)newExterior).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Gml4wcsPackage.POLYGON_TYPE__EXTERIOR, null, msgs);
            msgs = basicSetExterior(newExterior, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.POLYGON_TYPE__EXTERIOR, newExterior, newExterior));
    }
    ...
    public EList getInterior() {
        if (interior == null) {
            interior = new EObjectContainmentEList(AbstractRingPropertyType.class, this, Gml4wcsPackage.POLYGON_TYPE__INTERIOR);
        }
        return interior;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Gml4wcsPackage.POLYGON_TYPE__EXTERIOR:
                return basicSetExterior(null, msgs);
            case Gml4wcsPackage.POLYGON_TYPE__INTERIOR:
