...
public class MetaDataPropertyTypeImpl extends EObjectImpl implements MetaDataPropertyType {
    ...
    protected EClass eStaticClass() {
        return Gml4wcsPackage.Literals.META_DATA_PROPERTY_TYPE;
    }
    ...
    public FeatureMap getMetaDataGroup() {
        if (metaDataGroup == null) {
            metaDataGroup = new BasicFeatureMap(this, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__META_DATA_GROUP);
        }
    ...
    public AbstractMetaDataType getMetaData() {
        return (AbstractMetaDataType)getMetaDataGroup().get(Gml4wcsPackage.Literals.META_DATA_PROPERTY_TYPE__META_DATA, true);
    }
    ...
    public NotificationChain basicSetMetaData(AbstractMetaDataType newMetaData, NotificationChain msgs) {
        return ((FeatureMap.Internal)getMetaDataGroup()).basicAdd(Gml4wcsPackage.Literals.META_DATA_PROPERTY_TYPE__META_DATA, newMetaData, msgs);
    }
    ...
    public void setAbout(String newAbout) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__ABOUT, oldAbout, about));
    }
    ...
    public void setActuate(ActuateType newActuate) {
        ...
        actuateESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__ACTUATE, oldActuate, actuate, !oldActuateESet));
    }
    ...
    public void unsetActuate() {
        ...
        actuateESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__ACTUATE, oldActuate, ACTUATE_EDEFAULT, oldActuateESet));
    }
    ...
    public void setArcrole(String newArcrole) {
        ...
        arcrole = newArcrole;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__ARCROLE, oldArcrole, arcrole));
    }
    ...
    public void setHref(String newHref) {
        ...
        href = newHref;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__HREF, oldHref, href));
    }
    ...
    public void setRemoteSchema(String newRemoteSchema) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__REMOTE_SCHEMA, oldRemoteSchema, remoteSchema));
    }
    ...
    public void setRole(String newRole) {
        ...
        role = newRole;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__ROLE, oldRole, role));
    }
    ...
    public void setShow(ShowType newShow) {
        ...
        showESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__SHOW, oldShow, show, !oldShowESet));
    }
    ...
    public void unsetShow() {
        ...
        showESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__SHOW, oldShow, SHOW_EDEFAULT, oldShowESet));
    }
    ...
    public void setTitle(String newTitle) {
        ...
        title = newTitle;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__TITLE, oldTitle, title));
    }
    ...
    public void setType(String newType) {
        ...
        typeESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__TYPE, oldType, type, !oldTypeESet));
    }
    ...
    public void unsetType() {
        ...
        typeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, Gml4wcsPackage.META_DATA_PROPERTY_TYPE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Gml4wcsPackage.META_DATA_PROPERTY_TYPE__META_DATA_GROUP:
                return ((InternalEList)getMetaDataGroup()).basicRemove(otherEnd, msgs);
            case Gml4wcsPackage.META_DATA_PROPERTY_TYPE__META_DATA:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case Gml4wcsPackage.META_DATA_PROPERTY_TYPE__META_DATA:
                return getMetaData();
            case Gml4wcsPackage.META_DATA_PROPERTY_TYPE__ABOUT:
                return getAbout();
            case Gml4wcsPackage.META_DATA_PROPERTY_TYPE__ACTUATE:
                return getActuate();
            case Gml4wcsPackage.META_DATA_PROPERTY_TYPE__ARCROLE:
                return getArcrole();
            case Gml4wcsPackage.META_DATA_PROPERTY_TYPE__HREF:
                return getHref();
            case Gml4wcsPackage.META_DATA_PROPERTY_TYPE__REMOTE_SCHEMA:
                return getRemoteSchema();
            case Gml4wcsPackage.META_DATA_PROPERTY_TYPE__ROLE:
                return getRole();
            case Gml4wcsPackage.META_DATA_PROPERTY_TYPE__SHOW:
                return getShow();
            case Gml4wcsPackage.META_DATA_PROPERTY_TYPE__TITLE:
                return getTitle();
            case Gml4wcsPackage.META_DATA_PROPERTY_TYPE__TYPE:
                return getType();
        }
