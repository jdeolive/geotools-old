...
public abstract class AbstractMetaDataTypeImpl extends EObjectImpl implements AbstractMetaDataType {
    ...
    protected EClass eStaticClass() {
        return Gml4wcsPackage.Literals.ABSTRACT_META_DATA_TYPE;
    }
    ...
    public FeatureMap getMixed() {
        if (mixed == null) {
            mixed = new BasicFeatureMap(this, Gml4wcsPackage.ABSTRACT_META_DATA_TYPE__MIXED);
        }
        return mixed;
    }
    ...
    public void setId(String newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.ABSTRACT_META_DATA_TYPE__ID, oldId, id));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case Gml4wcsPackage.ABSTRACT_META_DATA_TYPE__ID:
                return getId();
        }
