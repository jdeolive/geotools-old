...
public class GridEnvelopeTypeImpl extends EObjectImpl implements GridEnvelopeType {
    ...
    protected EClass eStaticClass() {
        return Gml4wcsPackage.Literals.GRID_ENVELOPE_TYPE;
    }
    ...
    public void setLow(List newLow) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.GRID_ENVELOPE_TYPE__LOW, oldLow, low));
    }
    ...
    public void setHigh(List newHigh) {
        ...
        high = newHigh;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.GRID_ENVELOPE_TYPE__HIGH, oldHigh, high));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Gml4wcsPackage.GRID_ENVELOPE_TYPE__LOW:
                return getLow();
            case Gml4wcsPackage.GRID_ENVELOPE_TYPE__HIGH:
                return getHigh();
        }
