...
public class TimePositionTypeImpl extends EObjectImpl implements TimePositionType {
    ...
    protected EClass eStaticClass() {
        return Gml4wcsPackage.Literals.TIME_POSITION_TYPE;
    }
    ...
    public void setValue(Object newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.TIME_POSITION_TYPE__VALUE, oldValue, value));
    }
    ...
    public void setCalendarEraName(String newCalendarEraName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.TIME_POSITION_TYPE__CALENDAR_ERA_NAME, oldCalendarEraName, calendarEraName));
    }
    ...
    public void setFrame(String newFrame) {
        ...
        frameESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.TIME_POSITION_TYPE__FRAME, oldFrame, frame, !oldFrameESet));
    }
    ...
    public void unsetFrame() {
        ...
        frameESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, Gml4wcsPackage.TIME_POSITION_TYPE__FRAME, oldFrame, FRAME_EDEFAULT, oldFrameESet));
    }
    ...
    public void setIndeterminatePosition(TimeIndeterminateValueType newIndeterminatePosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.TIME_POSITION_TYPE__INDETERMINATE_POSITION, oldIndeterminatePosition, indeterminatePosition, !oldIndeterminatePositionESet));
    }
    ...
    public void unsetIndeterminatePosition() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, Gml4wcsPackage.TIME_POSITION_TYPE__INDETERMINATE_POSITION, oldIndeterminatePosition, INDETERMINATE_POSITION_EDEFAULT, oldIndeterminatePositionESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Gml4wcsPackage.TIME_POSITION_TYPE__VALUE:
                return getValue();
            case Gml4wcsPackage.TIME_POSITION_TYPE__CALENDAR_ERA_NAME:
                return getCalendarEraName();
            case Gml4wcsPackage.TIME_POSITION_TYPE__FRAME:
                return getFrame();
            case Gml4wcsPackage.TIME_POSITION_TYPE__INDETERMINATE_POSITION:
