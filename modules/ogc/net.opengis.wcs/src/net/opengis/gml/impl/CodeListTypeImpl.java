...
public class CodeListTypeImpl extends EObjectImpl implements CodeListType {
    ...
    protected EClass eStaticClass() {
        return Gml4wcsPackage.Literals.CODE_LIST_TYPE;
    }
    ...
    public void setValue(List newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.CODE_LIST_TYPE__VALUE, oldValue, value));
    }
    ...
    public void setCodeSpace(String newCodeSpace) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.CODE_LIST_TYPE__CODE_SPACE, oldCodeSpace, codeSpace));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Gml4wcsPackage.CODE_LIST_TYPE__VALUE:
                return getValue();
            case Gml4wcsPackage.CODE_LIST_TYPE__CODE_SPACE:
                return getCodeSpace();
        }
