...
import net.opengis.gml.util.Gml4wcsValidator;
 ...
 * @generated
 */
public class Gml4wcsPackageImpl extends EPackageImpl implements Gml4wcsPackage {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     ...
     * @see net.opengis.gml.Gml4wcsPackage#eNS_URI
     * @see #init()
     * @generated
     */
    private Gml4wcsPackageImpl() {
        super(eNS_URI, Gml4wcsFactory.eINSTANCE);
    }
     ...
     * @generated
     */
    public static Gml4wcsPackage init() {
        if (isInited) return (Gml4wcsPackage)EPackage.Registry.INSTANCE.getEPackage(Gml4wcsPackage.eNS_URI);

        // Obtain or create and register package
        Gml4wcsPackageImpl theGml4wcsPackage = (Gml4wcsPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof Gml4wcsPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new Gml4wcsPackageImpl());
        ...
        theGml4wcsPackage.createPackageContents();

        // Initialize created meta-data
        theGml4wcsPackage.initializePackageContents();
            ...
            (theGml4wcsPackage, 
             new EValidator.Descriptor() {
                 public EValidator getEValidator() {
                     return Gml4wcsValidator.INSTANCE;
                 }
             });

        // Mark meta-data to indicate it can't be changed
        theGml4wcsPackage.freeze();

        return theGml4wcsPackage;
    }
     ...
     * @generated
     */
    public Gml4wcsFactory getGml4wcsFactory() {
        return (Gml4wcsFactory)getEFactoryInstance();
    }
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getAbstractGeometryType_SrsName(), theXMLTypePackage_1.getAnyURI(), "srsName", null, 0, 1, AbstractGeometryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getAbstractMetaDataType_Id(), theXMLTypePackage_1.getID(), "id", null, 0, 1, AbstractMetaDataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getCodeListType_CodeSpace(), theXMLTypePackage_1.getAnyURI(), "codeSpace", null, 0, 1, CodeListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(codeTypeEClass, CodeType.class, "CodeType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getCodeType_Value(), theXMLTypePackage_1.getString(), "value", null, 0, 1, CodeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getCodeType_CodeSpace(), theXMLTypePackage_1.getAnyURI(), "codeSpace", null, 0, 1, CodeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getDirectPositionType_Dimension(), theXMLTypePackage_1.getPositiveInteger(), "dimension", null, 0, 1, DirectPositionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getDocumentRoot_Id(), theXMLTypePackage_1.getID(), "id", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDocumentRoot_RemoteSchema(), theXMLTypePackage_1.getAnyURI(), "remoteSchema", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(envelopeTypeEClass, /* EnvelopeType.class */ Envelope.class, "EnvelopeType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        ...
        initEAttribute(getEnvelopeWithTimePeriodType_Frame(), theXMLTypePackage_1.getAnyURI(), "frame", "#ISO-8601", 0, 1, EnvelopeWithTimePeriodType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEClass(gridLimitsTypeEClass, Envelope.class, "GridLimitsType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getGridLimitsType_GridEnvelope(), this.getGridEnvelopeType(), null, "gridEnvelope", null, 1, 1, Envelope.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getGridType_AxisName(), theXMLTypePackage_1.getString(), "axisName", null, 1, -1, GridType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getGridType_Dimension(), theXMLTypePackage_1.getPositiveInteger(), "dimension", null, 1, 1, GridType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getMetaDataPropertyType_About(), theXMLTypePackage_1.getAnyURI(), "about", null, 0, 1, MetaDataPropertyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getMetaDataPropertyType_Arcrole(), theXMLTypePackage_1.getAnyURI(), "arcrole", null, 0, 1, MetaDataPropertyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMetaDataPropertyType_Href(), theXMLTypePackage_1.getAnyURI(), "href", null, 0, 1, MetaDataPropertyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMetaDataPropertyType_RemoteSchema(), theXMLTypePackage_1.getAnyURI(), "remoteSchema", null, 0, 1, MetaDataPropertyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMetaDataPropertyType_Role(), theXMLTypePackage_1.getAnyURI(), "role", null, 0, 1, MetaDataPropertyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getMetaDataPropertyType_Title(), theXMLTypePackage_1.getString(), "title", null, 0, 1, MetaDataPropertyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getMetaDataPropertyType_Type(), theXMLTypePackage_1.getString(), "type", "simple", 0, 1, MetaDataPropertyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getReferenceType_Arcrole(), theXMLTypePackage_1.getAnyURI(), "arcrole", null, 0, 1, ReferenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getReferenceType_Href(), theXMLTypePackage_1.getAnyURI(), "href", null, 0, 1, ReferenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getReferenceType_RemoteSchema(), theXMLTypePackage_1.getAnyURI(), "remoteSchema", null, 0, 1, ReferenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getReferenceType_Role(), theXMLTypePackage_1.getAnyURI(), "role", null, 0, 1, ReferenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getReferenceType_Title(), theXMLTypePackage_1.getString(), "title", null, 0, 1, ReferenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getReferenceType_Type(), theXMLTypePackage_1.getString(), "type", "simple", 0, 1, ReferenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getStringOrRefType_Value(), theXMLTypePackage_1.getString(), "value", null, 0, 1, StringOrRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getStringOrRefType_Arcrole(), theXMLTypePackage_1.getAnyURI(), "arcrole", null, 0, 1, StringOrRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStringOrRefType_Href(), theXMLTypePackage_1.getAnyURI(), "href", null, 0, 1, StringOrRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStringOrRefType_RemoteSchema(), theXMLTypePackage_1.getAnyURI(), "remoteSchema", null, 0, 1, StringOrRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStringOrRefType_Role(), theXMLTypePackage_1.getAnyURI(), "role", null, 0, 1, StringOrRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getStringOrRefType_Title(), theXMLTypePackage_1.getString(), "title", null, 0, 1, StringOrRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getStringOrRefType_Type(), theXMLTypePackage_1.getString(), "type", "simple", 0, 1, StringOrRefType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getTimePositionType_CalendarEraName(), theXMLTypePackage_1.getString(), "calendarEraName", null, 0, 1, TimePositionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTimePositionType_Frame(), theXMLTypePackage_1.getAnyURI(), "frame", "#ISO-8601", 0, 1, TimePositionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
