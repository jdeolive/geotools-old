...
public class RectifiedGridTypeImpl extends GridTypeImpl implements RectifiedGridType {
    ...
    protected EClass eStaticClass() {
        return Gml4wcsPackage.Literals.RECTIFIED_GRID_TYPE;
    }
    ...
    public NotificationChain basicSetOrigin(PointType newOrigin, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.RECTIFIED_GRID_TYPE__ORIGIN, oldOrigin, newOrigin);
    ...
    public void setOrigin(PointType newOrigin) {
        if (newOrigin != origin) {
            ...
            if (origin != null)
                msgs = ((InternalEObject)origin).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Gml4wcsPackage.RECTIFIED_GRID_TYPE__ORIGIN, null, msgs);
            if (newOrigin != null)
                msgs = ((InternalEObject)newOrigin).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Gml4wcsPackage.RECTIFIED_GRID_TYPE__ORIGIN, null, msgs);
            msgs = basicSetOrigin(newOrigin, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.RECTIFIED_GRID_TYPE__ORIGIN, newOrigin, newOrigin));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Gml4wcsPackage.RECTIFIED_GRID_TYPE__ORIGIN:
                return basicSetOrigin(null, msgs);
            case Gml4wcsPackage.RECTIFIED_GRID_TYPE__OFFSET_VECTOR:
