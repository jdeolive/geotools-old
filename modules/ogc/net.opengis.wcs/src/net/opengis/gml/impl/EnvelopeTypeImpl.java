...
public class EnvelopeTypeImpl extends AbstractGeometryTypeImpl implements EnvelopeType {
    ...
    protected EClass eStaticClass() {
        return Gml4wcsPackage.Literals.ENVELOPE_TYPE;
    }
    ...
    public EList getPos() {
        if (pos == null) {
            pos = new EObjectContainmentEList(DirectPositionType.class, this, Gml4wcsPackage.ENVELOPE_TYPE__POS);
        }
        return pos;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Gml4wcsPackage.ENVELOPE_TYPE__POS:
