...
public class DirectPositionTypeImpl extends EObjectImpl implements DirectPositionType {
    ...
    protected EClass eStaticClass() {
        return Gml4wcsPackage.Literals.DIRECT_POSITION_TYPE;
    }
    ...
    public void setValue(List newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.DIRECT_POSITION_TYPE__VALUE, oldValue, value));
    }
    ...
    public void setDimension(BigInteger newDimension) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Gml4wcsPackage.DIRECT_POSITION_TYPE__DIMENSION, oldDimension, dimension));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Gml4wcsPackage.DIRECT_POSITION_TYPE__VALUE:
                return getValue();
            case Gml4wcsPackage.DIRECT_POSITION_TYPE__DIMENSION:
                return getDimension();
        }
