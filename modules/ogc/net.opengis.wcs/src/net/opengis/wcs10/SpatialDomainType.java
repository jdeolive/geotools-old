 ...
 * <ul>
 *   <li>{@link net.opengis.wcs10.SpatialDomainType#getEnvelopeGroup <em>Envelope Group</em>}</li>
...
public interface SpatialDomainType extends EObject {
     ...
     * @model type="com.vividsolutions.jts.geom.Envelope" containment="true" required="true" transient="true" volatile="true" derived="true"
