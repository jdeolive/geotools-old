 ...
 * <ul>
 *   <li>{@link net.opengis.wcs10.impl.SpatialDomainTypeImpl#getEnvelopeGroup <em>Envelope Group</em>}</li>
...
//        return getEnvelopeGroup().list(Wcs10Package.Literals.SPATIAL_DOMAIN_TYPE__ENVELOPE);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Wcs10Package.SPATIAL_DOMAIN_TYPE__ENVELOPE_GROUP:
