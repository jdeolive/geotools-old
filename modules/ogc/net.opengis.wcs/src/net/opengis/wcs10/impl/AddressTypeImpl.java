...
public class AddressTypeImpl extends EObjectImpl implements AddressType {
    ...
    public EList getDeliveryPoint() {
        if (deliveryPoint == null) {
            deliveryPoint = new EDataTypeEList(String.class, this, Wcs10Package.ADDRESS_TYPE__DELIVERY_POINT);
        }
    ...
    public EList getElectronicMailAddress() {
        if (electronicMailAddress == null) {
            electronicMailAddress = new EDataTypeEList(String.class, this, Wcs10Package.ADDRESS_TYPE__ELECTRONIC_MAIL_ADDRESS);
        }
