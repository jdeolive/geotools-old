...
public interface RasterStorage {
    ...
    public enum AccessType {
         ...
         * <p>
         * This level of access implys {@link RasterStorage#access(Name, Map, RequestType, Hints, ProgressListener)} is able to
         * return a {@link RasterDataset}
         */
        READ_ONLY,
        /**
     ...
     * @throws IOException
     */
    public List<Name> getCoverageNames(final ProgressListener listener);
     ...
     * a {@link RasterDataset}.
     * <p>
     * 
     * @return Param a {@link Map} describing the {@link Map} for
     *         {@link #connect(Map)}.
     */
    public Map<String, Parameter<?>> getParameterInfoDescription(Action action,AccessType accessType);
     ...
     */
    public RasterDataset performAction(Name name, Map<String, Serializable> params,
            Action action,AccessType accessType, Hints hints, ProgressListener listener)
            throws IOException;
     ...
     */
    public boolean canPerformAction(Action action,Name name, Map<String, Serializable> params,Hints hints, ProgressListener listener) throws IOException;
     ...
     *         {@link RasterStorage}.
     */
    public Map<String, Serializable> getDriverParameters();
	...
	public boolean isAccessTypeSupported(AccessType accessType);
