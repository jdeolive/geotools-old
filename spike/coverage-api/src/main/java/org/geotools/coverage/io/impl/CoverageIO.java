...
public class CoverageIO {
     ...
     *         present.
     */
    public static boolean canCreateCoverageDataSetProcess(
            java.util.Map<String, Serializable> params) {
        return false;
    }

    public static boolean canOpenCoverageDataSetProcess(
            java.util.Map<String, Serializable> params) {
        return false;
    }

    public static CoverageAccess createCoverageDataSet(
            Map<String, Serializable> params) throws IOException {
        return null;
    }

    public static CoverageAccess openCoverageDataSet(
            Map<String, Serializable> params) throws IOException {
        return null;
    }

    public static Set<? extends Driver> getAvailableCoverageService() {
        return null;
    }
