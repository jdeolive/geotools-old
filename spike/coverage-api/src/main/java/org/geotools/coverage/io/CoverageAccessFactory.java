...
public interface CoverageAccessFactory extends Factory {
	 ...
	 * 	 
	 * <p>
	 * Note that, by mean of the <code>canCreate</code> parameter we can 
	 * ask this method whether to fail or not in case the {@link CoverageAccess} we 
	 ...
	 */
	public CoverageAccess connect(Map<String, Parameter<?>> params,Hints hints,final ProgressListener listener, boolean canCreate)
			throws IOException;
	 ...
	 * the datasource is a file reading data source then the extensions or mime
	 * types of any files specified should be checked.
	 * should be case insensitive.
	 * 
	 * <p>
	 * Note that, by mean of the <code>failIfNotExists</code> parameter we can 
	 * ask this method whether to fail or not in case the {@link CoverageAccess} we 
	 * are trying to access does not exist.
	 * 
	 * @param params
	 ...
	 *         pressent.
	 */
	boolean canConnect(Map<String, Parameter<?>> params, boolean failIfNotExists);
}
