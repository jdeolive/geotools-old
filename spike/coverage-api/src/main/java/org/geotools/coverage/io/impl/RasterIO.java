...
import org.geotools.coverage.io.driver.Driver.Action;
...
public class RasterIO{
    ...
    public static Driver[] getAvailableDriversArray() {
        final Set<? extends Driver> drivers = RasterIO.getAvailableDrivers();
    ...
    public static Set<Driver> findDrivers(URL url) {
        final Set<? extends Driver> availaibleDrivers = RasterIO.getAvailableDrivers();
        final Set<Driver> drivers = new HashSet<Driver>();
