...
public abstract class BaseDriver implements Driver {
	...
	public boolean canProcess(
			final DriverOperation operation,
    ...
    public CoverageAccess process(
    		final DriverOperation operation,
    		final Map<String, Serializable> params, Hints hints,
     ...
     * @return false - subclass can override when delete is implemented
     */
    protected abstract CoverageAccess delete(Map<String, Serializable> params,Hints hints,ProgressListener listener)throws IOException;
    
    protected abstract CoverageAccess connect(Map<String, Serializable> params,Hints hints, ProgressListener listener) throws IOException;
    
    protected abstract CoverageAccess create(Map<String, Serializable> params,Hints hints, ProgressListener listener) throws IOException;
